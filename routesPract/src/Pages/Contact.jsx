                    ...
                    <div className="row">
                      <div className="col-lg-4">
                        <div className="info-item">
                          ...
                          <h4><a href="tel:0100200340">010-020-0340</a></h4>
                        </div>
                      </div>
                      <div className="col-lg-4">
                        <div className="info-item">
                          <i className="fa fa-envelope"></i>
                          <h4><a href="mailto:info@company.com">info@company.com</a></h4>
                          <h4><a href="mailto:hello@company.com">hello@company.com</a></h4>
                        </div>
                      </div>
                      <div className="col-lg-4">
                        <div className="info-item">
                          <i className="fa fa-map-marker"></i>
                          <h4><a href="#map">Sunny Isles Beach, FL 33160, United States</a></h4>
                        </div>
                      </div>
                    </div>
                  </div>
